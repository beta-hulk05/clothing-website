      ...
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 py-10'>
        ...
        <div>
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Link to="https://www.instagram.com/rnyclothing_?igsh=ancyeWpkdXgzM2U1" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full flex items-center justify-center bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:shadow-md transition-all">
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
        ...
        <div>
            ...
            <ul className='flex flex-col gap-3 text-gray-600'>
                <li className="hover:text-purple-700 transition-colors">
                  <a href="/" onClick={(e) => handleNavigation('/', e)} className="hover:text-purple-700 transition-colors">Home</a>
                </li>
                <li className="hover:text-purple-700 transition-colors">
                  <a href="/collection" onClick={(e) => handleNavigation('/collection', e)} className="hover:text-purple-700 transition-colors">Collection</a>
                </li>
                <li className="hover:text-purple-700 transition-colors">
                  <a href="/about" onClick={(e) => handleNavigation('/about', e)} className="hover:text-purple-700 transition-colors">About Us</a>
                </li>
                <li className="hover:text-purple-700 transition-colors">
                  <a href="/contact" onClick={(e) => handleNavigation('/contact', e)} className="hover:text-purple-700 transition-colors">Contact Us</a>
                </li>
                <li className="hover:text-purple-700 transition-colors">
                  <a href="/cart" onClick={(e) => handleNavigation('/cart', e)} className="hover:text-purple-700 transition-colors">Cart</a>
                </li>
            </ul>
        </div>
